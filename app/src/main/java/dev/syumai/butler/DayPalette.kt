...
/** Colors of the default illustration's sky at one time of day; ARGB ints, always fully opaque. */
class DayPalette(val sky: IntArray /* 3 gradient stops, top → horizon */, val sun: Int) {
    companion object {
        // CLEAR_NIGHT sky from SceneArt, reused here so the default illustration matches the weather
        ...
        val keyframes: List<Pair<Int, DayPalette>> = listOf(
            ...
            720 to DayPalette( // 12:00 NOON (= CLEAR_DAY sky)
